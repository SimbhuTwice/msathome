...
if(isset($_GET['act'])){
if($_GET['act'] == 'del' ){
	mysqli_query($conn,"update patientinfo set IsActive='N' WHERE id = '$_GET[id]' ");
                ...
                <div class="card-body">
                  ...
                  <div class="material-datatables">
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
					  <?php $result_query = mysqli_query($conn,"select ID,PatientId,FirstName,LastName,City,Pincode,age,sex,Contact_Number from patientinfo where IsActive='Y'");
...
while($result = mysqli_fetch_array($result_query))
{
					  ?>
                        <tr>
                          ...
                          <td class="text-right">
                          <a href="editPatientInfo.php?id=<?php echo $result['ID'];?>" class="btn btn-link btn-warning btn-just-icon edit"><i class="material-icons">create</i></a>
...
function conf_delete(val,id){
	if(val == 1 )
		window.location.href='ViewPatientInfo.php?id='+id+'&act=del';
	else
		$alert.slideUp(400);
}
  </script>
